...
class Metadados:
    ...
    class TV:
        """No domicílio tem televisor em cores? Quantos?"""
        _label = 'No domicílio tem televisor em cores? Quantos?'
        NAO_TEM = MetaValue(0.0, 'TV')
        V_4_OU_MAIS = MetaValue(4.0, 'TV')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class RADIO:
        """No domicílio tem rádio? Considere todos os rádios da casa, incluindo os rádios de aparelhos de som, de walkman. Não considerar rádio de automóveis. Quantos?"""
        _label = 'No domicílio tem rádio? Considere todos os rádios da casa, incluindo os rádios de aparelhos de som, de walkman. Não considerar rádio de automóveis. Quantos?'
        NAO_TEM = MetaValue(0.0, 'RADIO')
        V_4_OU_MAIS = MetaValue(4.0, 'RADIO')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class BANHEIRO:
        """No domicílio tem banheiros, incluindo todos os banheiros do domicílio, inclusive o de empregada? Quantos?"""
        _label = 'No domicílio tem banheiros, incluindo todos os banheiros do domicílio, inclusive o de empregada? Quantos?'
        NAO_TEM = MetaValue(0.0, 'BANHEIRO')
        V_4_OU_MAIS = MetaValue(4.0, 'BANHEIRO')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class AUTOMOVEL:
        """No domicílio tem automóveis de passeio? Não considerar caminhões e veículos usados como taxi ou vans, kombis e caminhonetes utilizadas para uso profissional. Quantos?"""
        _label = 'No domicílio tem automóveis de passeio? Não considerar caminhões e veículos usados como taxi ou vans, kombis e caminhonetes utilizadas para uso profissional. Quantos?'
        NAO_TEM = MetaValue(0.0, 'AUTOMOVEL')
        V_4_OU_MAIS = MetaValue(4.0, 'AUTOMOVEL')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class EMPREGADA:
        """No domicílio tem empregada doméstica ou outros empregados da casa que trabalhem pelo menos 5 dias na semana. Quantos?"""
        _label = 'No domicílio tem empregada doméstica ou outros empregados da casa que trabalhem pelo menos 5 dias na semana. Quantos?'
        NAO_TEM = MetaValue(0.0, 'EMPREGADA')
        V_4_OU_MAIS = MetaValue(4.0, 'EMPREGADA')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class LAVA_ROUPA:
        """No domicílio tem máquina de lavar roupa do tipo que executa todo o processo de lavagem, desde o molho até a centrifugação. Não considerar o tipo "tanquinho". Quantos?"""
        _label = 'No domicílio tem máquina de lavar roupa do tipo que executa todo o processo de lavagem, desde o molho até a centrifugação. Não considerar o tipo "tanquinho". Quantos?'
        NAO_TEM = MetaValue(0.0, 'LAVA_ROUPA')
        V_4_OU_MAIS = MetaValue(4.0, 'LAVA_ROUPA')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class GELADEIRA:
        """No domicílio tem geladeira simples ou do tipo "duplex". Quantas?"""
        _label = 'No domicílio tem geladeira simples ou do tipo "duplex". Quantas?'
        NAO_TEM = MetaValue(0.0, 'GELADEIRA')
        V_4_OU_MAIS = MetaValue(4.0, 'GELADEIRA')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class FREEZER:
        """No domicílio tem freezer independente ou aquele que faz parte da geladeira, do tipo "duplex". Quantos?"""
        _label = 'No domicílio tem freezer independente ou aquele que faz parte da geladeira, do tipo "duplex". Quantos?'
        NAO_TEM = MetaValue(0.0, 'FREEZER')
        V_4_OU_MAIS = MetaValue(4.0, 'FREEZER')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class LAVA_LOUCA:
        """No domicílio tem máquina lava-louças? Quantas?"""
        _label = 'No domicílio tem máquina lava-louças? Quantas?'
        NAO_TEM = MetaValue(0.0, 'LAVA_LOUCA')
        V_4_OU_MAIS = MetaValue(4.0, 'LAVA_LOUCA')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class DVD:
        """No domicílio tem DVD, incluindo outros aparelhos que reproduzem DVD, como videogames, computadores e notebooks, inclusive nos formatos mais modernos. Não considere DVD de carro? Quantos?"""
        _label = 'No domicílio tem DVD, incluindo outros aparelhos que reproduzem DVD, como videogames, computadores e notebooks, inclusive nos formatos mais modernos. Não considere DVD de carro? Quantos?'
        NAO_TEM = MetaValue(0.0, 'DVD')
        V_4_OU_MAIS = MetaValue(4.0, 'DVD')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class MICRO_ONDAS:
        """No domicílio tem microondas? Quantos?"""
        _label = 'No domicílio tem microondas? Quantos?'
        NAO_TEM = MetaValue(0.0, 'MICRO_ONDAS')
        V_4_OU_MAIS = MetaValue(4.0, 'MICRO_ONDAS')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class MOTOCICLETA:
        """No domicílio tem motocicleta? Seja de uso exclusivo para passeio ou uso misto (trabalho e passeio). Não considerar somente trabalho. Quantas?"""
        _label = 'No domicílio tem motocicleta? Seja de uso exclusivo para passeio ou uso misto (trabalho e passeio). Não considerar somente trabalho. Quantas?'
        NAO_TEM = MetaValue(0.0, 'MOTOCICLETA')
        V_4_OU_MAIS = MetaValue(4.0, 'MOTOCICLETA')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class SECADORA:
        """No domicílio tem secadora de roupas? Quantas?"""
        _label = 'No domicílio tem secadora de roupas? Quantas?'
        NAO_TEM = MetaValue(0.0, 'SECADORA')
        V_4_OU_MAIS = MetaValue(4.0, 'SECADORA')
        _map = {
            0.0: 'Não tem',
            4.0: '4 ou mais',
        }
    ...
    class TELEFONE_FIXO:
        """No domicílio tem telefone fixo (não o aparelho, mas a linha telefônica)?"""
        _label = 'No domicílio tem telefone fixo (não o aparelho, mas a linha telefônica)?'
        NAO_TEM = MetaValue(0.0, 'TELEFONE_FIXO')
        TEM = MetaValue(1.0, 'TELEFONE_FIXO')
        _map = {
            0.0: 'Não tem',
            1.0: 'Tem',
        }
    ...
    class VIDEOGAME:
        """No domicílio tem aparelho de jogo ou vídeo game, Playstation, Nintendo Wii, Xbox?"""
        _label = 'No domicílio tem aparelho de jogo ou vídeo game, Playstation, Nintendo Wii, Xbox?'
        NAO_TEM = MetaValue(0.0, 'VIDEOGAME')
        TEM = MetaValue(1.0, 'VIDEOGAME')
        _map = {
            0.0: 'Não tem',
            1.0: 'Tem',
        }
    ...
    class AGUA:
        ...
        _label = 'Tipo de abastecimento de água'
        REDE_GERAL_DE_DISTRIBUICAO = MetaValue(1.0, 'AGUA')
        POCO_OU_NASCENTE = MetaValue(2.0, 'AGUA')
        OUTRO_MEIO = MetaValue(3.0, 'AGUA')
        _map = {
